                        ...
                        <div class="center-content">
                            ...
                            <div class="guitar-type-container">
                                @foreach($guitar->guitarTypes as $guitarType)
                                    <a href="{{ route('type.show', ['id' => str_slug($guitarType->name_en)])}}"><span class="guitar-type">{{ $guitarType->{"name_" . LaravelLocalization::getCurrentLocale()} }}</span></a>
                                @endforeach
                            </div>
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    marker.addListener('click', function() {
                        ...
                        infowindow.setContent(
                            ...
                            "<br><br><strong>" + this.user.first_name + ' ' + (this.user.last_name ? this.user.last_name : '') + "</strong></a>" +
