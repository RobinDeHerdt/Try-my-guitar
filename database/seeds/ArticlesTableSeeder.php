...
class ArticlesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('articles')->insert([
            'title' => "\"Yellow cloud\" onder de hamer",
            'image_uri' => 'images/matt-heafy.jpg',
            'body' => 'De unieke \'yellow cloud\'-gitaar van Prince wordt vanaf 24 juni te koop aangeboden door veilinghuis Heritage Auctions. Het startbedrag bedraagt 30.000 dollar (26.500 euro).',
            'user_id' => 4,
            'lang' => 'nl',
        ]);
